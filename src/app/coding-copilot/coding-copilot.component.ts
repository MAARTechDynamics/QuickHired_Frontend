...
@Component({
  ...
  templateUrl: './coding-copilot.component.html',
  styleUrl: './coding-copilot.component.css'
})
export class CodingCopilotComponent implements OnInit {
  isWhiteBg = false;
  ...
  private apiUrlSupport = `${environment.apiBaseUrl}/api/SecurityMaster/support-submit`;
    ...
    constructor(
      ...
      ngOnInit() {
        // Set SEO meta tags
        this.titleService.setTitle('AI Coding Copilot - Real-Time Interview Help | QuickHired');
        
        this.metaService.updateTag({ 
          name: 'description', 
          content: 'Master coding interviews with QuickHired AI Coding Copilot. Get real-time assistance for LeetCode, HackerRank, and live coding challenges. Solve complex problems in under 3 seconds with intelligent AI support.' 
        });
        
        this.metaService.updateTag({ 
          name: 'keywords', 
          content: 'coding copilot, AI coding assistant, interview coding help, LeetCode helper, HackerRank AI, coding interview preparation, real-time coding support, algorithm problem solver, technical interview AI, software engineer interview tool' 
        });

        // Open Graph tags
        this.metaService.updateTag({ property: 'og:title', content: 'AI Coding Copilot - Real-Time Interview Help | QuickHired' });
        this.metaService.updateTag({ property: 'og:description', content: 'Solve coding interview challenges with AI-powered real-time assistance. Support for all major coding platforms.' });
        this.metaService.updateTag({ property: 'og:type', content: 'website' });
        this.metaService.updateTag({ property: 'og:url', content: 'https://quickhired.com/coding-copilot' });
        ...
        this.metaService.updateTag({ name: 'twitter:title', content: 'AI Coding Copilot - Real-Time Interview Help' });
        this.metaService.updateTag({ name: 'twitter:description', content: 'Master coding interviews with AI-powered real-time assistance for all major platforms.' });
    ...
    features = [
  {
    ...
    description: 'Start your interview assistance with a single click—no setup or delay.',
    image: 'ki-outline ki-switch',
    hover: false
  },
  {
    title: 'All-in-One Support',
    description: 'Get end-to-end support from resume to post-interview feedback—all in one place.',
    image: 'ki-outline ki-category',
    hover: false
  },
  {
    title: 'Real-Time Outcomes',
    description: 'Experience lightning-fast insights, answers, and analysis the moment you need them.',
    image: 'ki-outline ki-timer',
    hover: false
  },
  {
    title: 'Smart AI Assistance',
    description: 'Harness the power of AI to solve complex questions and tailor smart responses effortlessly.',
