...
@Component({
  ...
  templateUrl: './hirevue-interview.component.html',
  styleUrl: './hirevue-interview.component.css'
})
export class HireVueInterviewComponent implements OnInit {
  isWhiteBg = false;
  ...
  private apiUrlSupport = `${environment.apiBaseUrl}/api/SecurityMaster/support-submit`;
    ...
    ngOnInit() {
      // Set SEO meta tags
      this.titleService.setTitle('HireVue Interview Practice - AI Video Interview Prep | QuickHired');

      this.metaService.updateTag({ 
        name: 'description', 
        content: 'Master HireVue interviews with AI-powered practice. Get real-time feedback, personalized coaching, and expert tips for video interviews at top companies.' 
      });

      this.metaService.updateTag({ 
        name: 'keywords', 
        content: 'HireVue interview, video interview practice, AI interview prep, HireVue tips, virtual interview coaching, interview practice platform, video interview skills' 
      });

      // Open Graph tags
      this.metaService.updateTag({ property: 'og:title', content: 'HireVue Interview Practice - AI Video Interview Prep' });
      this.metaService.updateTag({ property: 'og:description', content: 'Master HireVue interviews with AI-powered practice and real-time feedback.' });
      this.metaService.updateTag({ property: 'og:type', content: 'website' });
      this.metaService.updateTag({ property: 'og:url', content: 'https://quickhired.com/hirevuew-interview' });
      ...
      this.metaService.updateTag({ name: 'twitter:title', content: 'HireVue Interview Practice - AI Video Interview Prep' });
      this.metaService.updateTag({ name: 'twitter:description', content: 'Master HireVue interviews with AI-powered practice and real-time feedback.' });
