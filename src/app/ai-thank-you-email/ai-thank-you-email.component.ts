...
@Component({
  ...
  templateUrl: './ai-thank-you-email.component.html',
  styleUrl: './ai-thank-you-email.component.css'
})
export class AIThankYouEmailComponent implements OnInit {
  isWhiteBg = false;
  ...
  private apiUrlSupport = `${environment.apiBaseUrl}/api/SecurityMaster/support-submit`;
    ...
    ngOnInit() {
      // Set SEO meta tags
      this.titleService.setTitle('AI Thank You Email Generator - Post-Interview Follow-up | QuickHired');

      this.metaService.updateTag({ 
        name: 'description', 
        content: 'Create professional thank you emails after interviews with AI. Stand out with personalized, timely follow-ups that strengthen your candidacy and leave a lasting impression.' 
      });

      this.metaService.updateTag({ 
        name: 'keywords', 
        content: 'thank you email, post-interview email, interview follow-up, thank you letter, professional email, interview thank you, AI email generator, job interview etiquette' 
      });

      // Open Graph tags
      this.metaService.updateTag({ property: 'og:title', content: 'AI Thank You Email Generator - Post-Interview Follow-up' });
      this.metaService.updateTag({ property: 'og:description', content: 'Create professional thank you emails after interviews with AI.' });
      this.metaService.updateTag({ property: 'og:type', content: 'website' });
      this.metaService.updateTag({ property: 'og:url', content: 'https://quickhired.com/ai-thank-you-email' });
      ...
      this.metaService.updateTag({ name: 'twitter:title', content: 'AI Thank You Email Generator - Post-Interview Follow-up' });
      this.metaService.updateTag({ name: 'twitter:description', content: 'Create professional thank you emails after interviews with AI.' });
