...
@Component({
  ...
  templateUrl: './question-bank-home.component.html',
  styleUrl: './question-bank-home.component.css'
})
export class QuestionBankHomeComponent implements OnInit {
  isWhiteBg = false;
  ...
  private apiUrlSupport = `${environment.apiBaseUrl}/api/SecurityMaster/support-submit`;
    ...
    ngOnInit() {
      // Set SEO meta tags
      this.titleService.setTitle('Interview Question Banks - Top Companies & Roles | QuickHired');

      this.metaService.updateTag({ 
        name: 'description', 
        content: 'Access comprehensive interview question banks for Google, Amazon, Microsoft, Meta and more. Practice technical, behavioral, and role-specific questions to ace your interviews.' 
      });

      this.metaService.updateTag({ 
        name: 'keywords', 
        content: 'interview questions, coding interview questions, behavioral questions, technical interview prep, company interview questions, FAANG interviews, system design questions' 
      });

      // Open Graph tags
      this.metaService.updateTag({ property: 'og:title', content: 'Interview Question Banks - Top Companies & Roles' });
      this.metaService.updateTag({ property: 'og:description', content: 'Access comprehensive interview question banks for top tech companies and roles.' });
      this.metaService.updateTag({ property: 'og:type', content: 'website' });
      this.metaService.updateTag({ property: 'og:url', content: 'https://quickhired.com/question-bank-home' });
      ...
      this.metaService.updateTag({ name: 'twitter:title', content: 'Interview Question Banks - Top Companies & Roles' });
      this.metaService.updateTag({ name: 'twitter:description', content: 'Access comprehensive interview question banks for top tech companies and roles.' });
