...
@Component({
  ...
  imports: [CommonModule, ReactiveFormsModule, HttpClientModule, RouterModule],
   templateUrl: './online-assessment-copilot.component.html',
  styleUrl: './online-assessment-copilot.component.css'
})
export class OnlineAssessmentCopilotComponent implements OnInit {
  isWhiteBg = false;
  ...
  private apiUrlSupport = `${environment.apiBaseUrl}/api/SecurityMaster/support-submit`;
    ...
    constructor(
     ...
     @HostListener('document:click', ['$event'])
      ...
      ngOnInit() {
        // Set SEO meta tags
        this.titleService.setTitle('Online Assessment Copilot - AI MCQ & Quiz Helper | QuickHired');
        
        this.metaService.updateTag({ 
          name: 'description', 
          content: 'Ace online assessments with QuickHired AI Copilot. Auto-detect and solve MCQs, logic puzzles, and technical quizzes instantly. Get real-time assistance for HackerRank, Codility, and all major assessment platforms.' 
        });
        
        this.metaService.updateTag({ 
          name: 'keywords', 
          content: 'online assessment copilot, MCQ solver, AI quiz helper, HackerRank assistant, Codility AI, technical assessment help, logic puzzle solver, aptitude test AI, online test copilot, assessment interview tool' 
        });

        // Open Graph tags
        this.metaService.updateTag({ property: 'og:title', content: 'Online Assessment Copilot - AI MCQ & Quiz Helper | QuickHired' });
        this.metaService.updateTag({ property: 'og:description', content: 'Auto-detect and solve MCQs, logic puzzles, and quizzes with AI-powered assistance.' });
        this.metaService.updateTag({ property: 'og:type', content: 'website' });
        this.metaService.updateTag({ property: 'og:url', content: 'https://quickhired.com/online-assessment-copilot' });
        ...
        this.metaService.updateTag({ name: 'twitter:title', content: 'Online Assessment Copilot - AI MCQ & Quiz Helper' });
        this.metaService.updateTag({ name: 'twitter:description', content: 'Ace online assessments with AI-powered real-time assistance.' });
