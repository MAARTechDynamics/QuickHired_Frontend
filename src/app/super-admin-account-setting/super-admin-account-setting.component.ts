...
@Component({
  selector: 'app-super-admin-account-setting',
  standalone: true, 
  imports: [HttpClientModule, RouterModule, CommonModule, ReactiveFormsModule, FormsModule],
  templateUrl: './super-admin-account-setting.component.html',
  styleUrl: './super-admin-account-setting.component.css'
})
export class SuperAdminAccountSettingComponent implements OnInit {
