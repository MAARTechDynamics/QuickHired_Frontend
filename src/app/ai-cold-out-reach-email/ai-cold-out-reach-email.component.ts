...
@Component({
  ...
  templateUrl: './ai-cold-out-reach-email.component.html',
  styleUrl: './ai-cold-out-reach-email.component.css'
})
export class AIColdOutReachEmailComponent implements OnInit {
  isWhiteBg = false;
  ...
  private apiUrlSupport = `${environment.apiBaseUrl}/api/SecurityMaster/support-submit`;
    ...
    ngOnInit() {
      // Set SEO meta tags
      this.titleService.setTitle('AI Recruiter Email Generator - Cold Outreach Tool | QuickHired');

      this.metaService.updateTag({ 
        name: 'description', 
        content: 'Generate professional cold outreach emails to recruiters with AI. Break through the noise with personalized, compelling messages that get responses and open doors to new opportunities.' 
      });

      this.metaService.updateTag({ 
        name: 'keywords', 
        content: 'cold email, recruiter outreach, networking email, cold contact, professional outreach, AI email generator, job search networking, recruiter cold email' 
      });

      // Open Graph tags
      this.metaService.updateTag({ property: 'og:title', content: 'AI Recruiter Email Generator - Cold Outreach Tool' });
      this.metaService.updateTag({ property: 'og:description', content: 'Generate professional cold outreach emails to recruiters with AI.' });
      this.metaService.updateTag({ property: 'og:type', content: 'website' });
      this.metaService.updateTag({ property: 'og:url', content: 'https://quickhired.com/ai-cold-out-reach-email' });
      ...
      this.metaService.updateTag({ name: 'twitter:title', content: 'AI Recruiter Email Generator - Cold Outreach Tool' });
      this.metaService.updateTag({ name: 'twitter:description', content: 'Generate professional cold outreach emails to recruiters with AI.' });
