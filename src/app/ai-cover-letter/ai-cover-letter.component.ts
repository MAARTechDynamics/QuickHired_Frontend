...
@Component({
  ...
  styleUrl: './ai-cover-letter.component.css'
})
export class AICoverLetterComponent implements OnInit {
  isWhiteBg = false;
  ...
  private apiUrlSupport = `${environment.apiBaseUrl}/api/SecurityMaster/support-submit`;
    ...
    ngOnInit() {
      // Set SEO meta tags
      this.titleService.setTitle('AI Cover Letter Generator - Customized Job Applications | QuickHired');

      this.metaService.updateTag({ 
        name: 'description', 
        content: 'Generate professional, customized cover letters instantly with AI. Tailored to your target role and company for maximum impact and higher response rates.' 
      });

      this.metaService.updateTag({ 
        name: 'keywords', 
        content: 'AI cover letter generator, cover letter writing, job application letter, professional cover letter, automated cover letter, custom cover letter, application writing tool' 
      });

      // Open Graph tags
      this.metaService.updateTag({ property: 'og:title', content: 'AI Cover Letter Generator - Customized Job Applications' });
      this.metaService.updateTag({ property: 'og:description', content: 'Generate professional, customized cover letters instantly with AI.' });
      this.metaService.updateTag({ property: 'og:type', content: 'website' });
      this.metaService.updateTag({ property: 'og:url', content: 'https://quickhired.com/ai-cover-letter' });
      ...
      this.metaService.updateTag({ name: 'twitter:title', content: 'AI Cover Letter Generator - Customized Job Applications' });
      this.metaService.updateTag({ name: 'twitter:description', content: 'Generate professional, customized cover letters instantly with AI.' });
